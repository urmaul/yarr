...
class BackendCode extends CCodeModel
{
	public $module;
	public $model;
	public $controller = 'backend';
	public $baseControllerClass='YBackendController';
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			array('module, model, controller', 'filter', 'filter'=>'trim'),
	...
	public function validateModel($attribute,$params)
	{
		...
		$class=@Yii::import($model,true);
		if(!is_string($class) || !$this->classExists($class))
			$this->addError('model', "Class '$model' does not exist or has syntax error.");
		else if(!is_subclass_of($class,'CActiveRecord'))
			$this->addError('model', "'$model' must extend from CActiveRecord.");
		else
		{
    ...
    {
        return "application.modules.{$this->module}.models.{$this->model}";
    }
}